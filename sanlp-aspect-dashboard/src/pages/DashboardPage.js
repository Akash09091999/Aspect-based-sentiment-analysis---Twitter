...
function DashboardPage() {
  ...
  let [addedHashtags,setAddedHashtags]=useState([])

  React.useEffect(async()=>{
    await axios.get(`get-hashtags/`).then((response) => {
      
      console.log(response.data);
      setAddedHashtags(response.data.hashtag_list)
    }).catch((err) => {
